...
void OMnetLogger::print(const account_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.country_id_s);
    print(item.ex_customer_s);
    print(item.account_id_s);
...
void OMnetLogger::print(const order_var_t& item) {
    ...
    print(item.ex_client_s);
    print(item.customer_info_s);
...
void OMnetLogger::print(const account_data_t& item) {
    ...
    print(item.risk_currency_s);
    print(item.modified_date_s);
    print(item.modified_time_s);
    print(item.created_date_s);
    print(item.created_time_s);
    print(item.investor_type_s);
    print(item.nationality_s);
    print(item.account_text_s);
    print(item.ext_acc_id_s);
    print(item.ext_acc_controller_s);
    print(item.ext_acc_registrar_s);
    print(item.org_number_s);
    print(item.account_alias_s);
    print(item.diary_number_s);
    print(item.acc_type_s);
    print(item.fee_type_s);
    print(item.cust_bank_id_s);
...
void OMnetLogger::print(const cl_delivery_api_t& item) {
    ...
    print(item.settlement_date_s);
    print(item.date_s);
    print(item.clearing_account);
    print(item.original_date_s);
    print(item.passthrough_s);
    ...
    print(item.giving_up_exchange_s);
    print(item.settlement_instr_date_s);
    loggerOMnet->log(Level, "filler_1_s: {}", item.filler_1_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const cl_give_up_api_t& item) {
    ...
    print(item.created_date_s);
    print(item.created_time_s);
    print(item.give_up_text_s);
    print(item.asof_date_s);
    print(item.asof_time_s);
    print(item.orig_clearing_date_s);
...
void OMnetLogger::print(const currency_ranking_connection_t& item) {
    ...
    print(item.currency_ranking_id_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const da24_t& item) {
    ...
    loggerOMnet->log(Level, "country_c: {}", item.country_c);
    print(item.name_s);
    print(item.exchange_short_s);
    print(item.country_id_s);
    print(item.tz_exchange_s);
    print(item.master_clh_id_s);
    print(item.country_s);
    print(item.date_implementation_s);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const deposit_withdraw_collateral_ssi_t& item) {
    ...
    print(item.isin_code_s);
    print(item.passthrough_s);
    print(item.instr_ref_s);
    print(item.cancel_ref_s);
    print(item.csd_code_s);
    print(item.reason_s);
    print(item.currency_s);
    loggerOMnet->log(Level, "filler_1_s: {}", item.filler_1_s);
...
void OMnetLogger::print(const da9_t& item) {
    ...
    print(item.isin_code_old_s);
    print(item.date_notation_s);
    print(item.date_last_trading_s);
    print(item.time_last_trading_s);
    print(item.date_delivery_start_s);
    print(item.date_delivery_stop_s);
...
void OMnetLogger::print(const da2_t& item) {
    ...
    print(item.date_delivery_stop_s);
    loggerOMnet->log(Level, "series_status_c: {}", item.series_status_c);
    print(item.long_ins_id_s);
    print(item.date_first_trading_s);
    print(item.time_first_trading_s);
    loggerOMnet->log(Level, "traded_in_click_c: {}", item.traded_in_click_c);
    print(item.abbr_name_s);
    print(item.stock_code_s);
...
void OMnetLogger::print(const answer_authorized_report_item_t& item) {
    ...
    print(item.country_id_s);
    print(item.ex_customer_s);
    print(item.report_name_s);
    print(item.report_template_s);
    print(item.report_template_desc_s);
    print(item.report_file_prefix_s);
    loggerOMnet->log(Level, "report_file_ext_c: {}", item.report_file_ext_c);
    print(item.report_spec_s);
    print(item.report_spec_desc_s);
    loggerOMnet->log(Level, "report_owner_type_c: {}", item.report_owner_type_c);
    print(item.csb_id_s);
    print(item.css_id_s);
    print(item.bank_id_s);
    print(item.clh_id_s);
    loggerOMnet->log(Level, "filler_1_s: {}", item.filler_1_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const answer_bi26_signals_sent_item_t& item) {
    ...
    print(item.clearing_date_s);
    print(item.clh_id_s);
    print(item.sent_date_s);
    print(item.sent_time_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const answer_clearing_date_item_t& item) {
    ...
    print(item.series);
    print(item.clearing_date_s);
    print(item.next_clearing_date_s);
    print(item.prev_clearing_date_s);
...
void OMnetLogger::print(const answer_currency_item_t& item) {
    ...
    print(item.base_cur_s);
    print(item.pri_unit_s);
    print(item.sec_unit_s);
    print(item.third_unit_s);
    print(item.pri_not_s);
    print(item.sec_not_s);
    print(item.third_not_s);
...
void OMnetLogger::print(const answer_deal_source_item_t& item) {
    ...
    print(item.desc_long_s);
    print(item.desc_abbreviated_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const answer_error_msg_item_t& item) {
    ...
    print(item.created_date_s);
    print(item.created_time_s);
    print(item.error_operation_s);
    loggerOMnet->log(Level, "error_id_u: {}", item.error_id_u);
    print(item.error_problem_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const answer_exchange_rate_item_t& item) {
    ...
    print(item.price_currency_s);
    print(item.other_currency_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const answer_instrument_class_item_t& item) {
    ...
    print(item.settl_cur_id_s);
    print(item.credit_class_s);
    print(item.csd_id_s);
    ...
    print(item.mbs_id_s);
    print(item.valuation_group_id_s);
...
void OMnetLogger::print(const answer_margin_detail_item_t& item) {
    ...
    print(item.cash_currency_s);
    print(item.margin_class_s);
...
void OMnetLogger::print(const answer_margin_series_param_ext_item_t& item) {
    ...
    loggerOMnet->log(Level, "fixed_vol_i: {}", item.fixed_vol_i);
    loggerOMnet->log(Level, "dividend_yield_i: {}", item.dividend_yield_i);
    print(item.marg_param_id_s);
    print(item.price_param_id_s);
    print(item.win_id_s);
    print(item.tdp_id_s);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
...
void OMnetLogger::print(const answer_market_item_t& item) {
    ...
    print(item.bic_code_s);
    print(item.mic_code_s);
...
void OMnetLogger::print(const answer_report_nrs_item_t& item) {
    ...
    print(item.clh_id_s);
    print(item.business_date_s);
    print(item.report_version_s);
    loggerOMnet->log(Level, "ascii_bin_c: {}", item.ascii_bin_c);
    print(item.file_name_s);
    print(item.file_type_s);
    print(item.created_date_s);
    print(item.created_time_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
...
void OMnetLogger::print(const answer_trd_report_item_t& item) {
    ...
    print(item.give_up_member);
    print(item.settlement_date_s);
    print(item.time_of_agreement_date_s);
    print(item.time_of_agreement_time_s);
...
void OMnetLogger::print(const answer_underlying_item_t& item) {
    ...
    print(item.isin_code_s);
    loggerOMnet->log(Level, "dec_in_price_n: {}", item.dec_in_price_n);
    print(item.date_release_s);
    print(item.date_termination_s);
    print(item.date_dated_s);
    print(item.name_s);
    print(item.base_cur_s);
    loggerOMnet->log(Level, "deliverable_c: {}", item.deliverable_c);
    ...
    print(item.underlying_issuer_s);
    print(item.time_delivery_start_s);
    print(item.time_delivery_stop_s);
    print(item.sector_code_s);
    loggerOMnet->log(Level, "items_n: {}", item.items_n);
    print(item.coupon);
    loggerOMnet->log(Level, "virtual_c: {}", item.virtual_c);
    print(item.member_circ_numb_s);
    loggerOMnet->log(Level, "inv_scheme_c: {}", item.inv_scheme_c);
    print(item.date_closing_s);
    print(item.date_last_s);
    print(item.country_id_s);
...
void OMnetLogger::print(const answer_underlying_adjustment_item_t& item) {
    ...
    loggerOMnet->log(Level, "adjust_ident_n: {}", item.adjust_ident_n);
    loggerOMnet->log(Level, "commodity_n: {}", item.commodity_n);
    print(item.date_adjust_s);
    print(item.date_conversion_s);
...
void OMnetLogger::print(const collateral_base_t& item) {
    ...
    loggerOMnet->log(Level, "amount_q: {}", item.amount_q);
    print(item.passthrough_s);
    print(item.effective_date_s);
    print(item.name_s);
    print(item.effective_until_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const instrument_status_info_item_t& item) {
    ...
    loggerOMnet->log(Level, "state_number_n: {}", item.state_number_n);
    print(item.warning_msg_s);
    loggerOMnet->log(Level, "state_level_e: {}", item.state_level_e);
    print(item.actual_start_date_s);
    print(item.actual_start_time_s);
    print(item.next_planned_start_date_s);
    print(item.next_planned_start_time_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const irs_leg_t& item) {
    ...
    print(item.first_rollover_date_s);
...
void OMnetLogger::print(const store_account_t& item) {
    ...
    print(item.fee_type_s);
    print(item.cust_bank_id_s);
    print(item.risk_cur_id_s);
    print(item.base_cur_id_s);
    print(item.investor_type_s);
    print(item.nationality_s);
    print(item.account_text_s);
    print(item.ext_acc_id_s);
...
void OMnetLogger::print(const answer_business_date_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.transaction_type);
    print(item.omex_version_s);
    print(item.business_date_s);
    print(item.utc_date_s);
    print(item.utc_time_s);
    print(item.tz_variable_s);
    print(item.filler_2_s);
...
void OMnetLogger::print(const answer_list_ver_t& item) {
    ...
    loggerOMnet->log(Level, "info_type_i: {}", item.info_type_i);
    loggerOMnet->log(Level, "segment_number_n: {}", item.segment_number_n);
    print(item.list_name_s);
    print(item.report_version_s);
    loggerOMnet->log(Level, "filler_1_s: {}", item.filler_1_s);
    print(item.file_type_s);
    loggerOMnet->log(Level, "items_n: {}", item.items_n);
    print(item.text_buffer_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const clearing_house_account_light_t& item) {
    ...
    print(item.clh_account_id_s);
    print(item.clh_id_s);
    print(item.bank_name_s);
    print(item.bic_code_s);
    print(item.account_number_s);
    print(item.account_name_s);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const collateral_evaluation_run_info_t& item) {
    ...
    print(item.margin_date_s);
    print(item.clearing_date_s);
    print(item.ca_batch_isin_code_s);
...
void OMnetLogger::print(const collateral_info_sgx_t& item) {
    ...
    print(item.timestamp_date_s);
    print(item.timestamp_time_s);
    print(item.asof_date_s);
    print(item.asof_time_s);
    print(item.name_s);
    loggerOMnet->log(Level, "collateral_type_c: {}", item.collateral_type_c);
...
void OMnetLogger::print(const corporate_action_info_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.corp_action_ref_s);
    print(item.corp_event_ref_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const market_info_index_t& item) {
    ...
    print(item.date_time_of_dist_s);
    print(item.date_time_of_comp_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const market_info_sgx_t& item) {
    ...
    print(item.previous_last_price_updated_date_s);
    print(item.previous_last_price_updated_time_s);
    print(item.filler_2_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const ns_coupon_dates_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.date_coupdiv_s);
    print(item.date_booksclose_s);
...
void OMnetLogger::print(const ns_inst_series_basic_single_t& item) {
    ...
    print(item.isin_code_s);
    print(item.settlement_date_s);
    print(item.first_settlement_date_s);
    print(item.date_notation_s);
    loggerOMnet->log(Level, "deliverable_c: {}", item.deliverable_c);
    print(item.effective_exp_date_s);
    loggerOMnet->log(Level, "ext_info_source_c: {}", item.ext_info_source_c);
...
void OMnetLogger::print(const ns_inst_type_secur_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.settlement_product_s);
    loggerOMnet->log(Level, "maintain_positions_c: {}", item.maintain_positions_c);
    loggerOMnet->log(Level, "post_trade_proc_c: {}", item.post_trade_proc_c);
    loggerOMnet->log(Level, "pos_handling_c: {}", item.pos_handling_c);
...
void OMnetLogger::print(const ns_pre_trade_limit_t& item) {
    ...
    print(item.ptl_suffix_s);
    print(item.country_id_s);
    print(item.ex_customer_s);
    print(item.spons_user_name_s);
    print(item.sponsored_client_country_id_s);
    print(item.sponsored_client_ex_customer_s);
...
void OMnetLogger::print(const otc_cash_flow_info_t& item) {
    ...
    print(item.reset_date_s);
    loggerOMnet->log(Level, "fixing_value_i: {}", item.fixing_value_i);
    print(item.trade_clearing_date);
    loggerOMnet->log(Level, "sequence_number_i: {}", item.sequence_number_i);
    ...
    print(item.estimated_consideration_date_s);
...
void OMnetLogger::print(const otc_fra_trade_report_t& item) {
    ...
    loggerOMnet->log(Level, "notional_amount_q: {}", item.notional_amount_q);
    loggerOMnet->log(Level, "fixed_interest_rate_i: {}", item.fixed_interest_rate_i);
    print(item.float_rate_fixing_date_s);
    print(item.date_termination_s);
    loggerOMnet->log(Level, "day_count_conv_c: {}", item.day_count_conv_c);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
...
void OMnetLogger::print(const otc_give_up_info_t& item) {
    ...
    loggerOMnet->log(Level, "give_up_number_i: {}", item.give_up_number_i);
    print(item.give_up_text_s);
    print(item.take_up_or_reject_text_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const otc_irs_data_t& item) {
    ...
    print(item.delivery_unit_date_s);
...
void OMnetLogger::print(const otc_option_t& item) {
    ...
    print(item.premium_settlement_date_s);
    loggerOMnet->log(Level, "premium_i: {}", item.premium_i);
    print(item.expiration_date_s);
    loggerOMnet->log(Level, "bought_or_sold_c: {}", item.bought_or_sold_c);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const private_price_list_id_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.private_price_list_id_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const query_closeout_log_t& item) {
    ...
    print(item.filler_2_s);
    print(item.account);
    print(item.series_id_s);
    print(item.from_date_s);
    print(item.from_time_s);
    print(item.to_date_s);
    print(item.to_time_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const query_collateral_transaction_t& item) {
    ...
    print(item.account_number_s);
    print(item.bic_code_s);
    print(item.clh_bank_account_number_s);
    print(item.clh_bank_bic_code_s);
    loggerOMnet->log(Level, "segment_number_n: {}", item.segment_number_n);
    loggerOMnet->log(Level, "items_n: {}", item.items_n);
    loggerOMnet->log(Level, "collateral_transaction_type_c: {}", item.collateral_transaction_type_c);
    loggerOMnet->log(Level, "filler_1_s: {}", item.filler_1_s);
...
void OMnetLogger::print(const rpt_service_t& item) {
    ...
    print(item.service_description_s);
...
void OMnetLogger::print(const sequence_number_info_int_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.created_clearing_date_s);
    print(item.modified_clearing_date_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const settlement_instruction_info_t& item) {
    ...
    print(item.account_name_s);
    print(item.bic_code_s);
    print(item.aba_number_s);
    print(item.clh_bank_account_number_s);
    print(item.clh_bank_account_name_s);
    print(item.clh_bank_bic_code_s);
    print(item.intermediary_bic_code_s);
    print(item.intermediary_bank_name_s);
    print(item.bank_id_s);
    print(item.clh_bank_id_s);
    print(item.filler_3_s);
    loggerOMnet->log(Level,"}");
}
...
void OMnetLogger::print(const used_comb_com_group_params_t& item) {
    ...
    print(item.filler_2_s);
    print(item.cco_id_1_s);
    print(item.cco_id_2_s);
    print(item.cco_id_3_s);
    print(item.cco_id_4_s);
...
void OMnetLogger::print(const used_global_risk_params_t& item) {
    loggerOMnet->log(Level,"{");
    print(item.pgr_id_s);
    print(item.default_currency_s);
    print(item.exchange_complex_s);
    print(item.risk_file_exchange_acronym_s);
    print(item.risk_file_exchange_code_s);
